...
DIR_PROJECT = r"C:\Users\sneha\clin-summ-data"
...
MODELS = {
    ...
    's2s-t5': { # seq2seq architectures
        "t5-xl": "t5-3b",
        "flan-t5-base": "google/flan-t5-base",  # ~1GB (faster download)
        "flan-t5-large": "google/flan-t5-large",  # ~3GB (good balance)
        "flan-t5-xl": "google/flan-t5-xl",  # ~11GB (best quality, slow download)
    },
    's2s-ul2': {
